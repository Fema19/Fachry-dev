  ...
  const ProjectCard = ({ project }: { project: typeof projects[0] }) => (
    <motion.div variants={staggerItem}>
      <Card interactive className="group h-full flex flex-col overflow-hidden">
        ...
        <div className="w-full h-48 bg-gradient-to-br from-sky-500/10 to-blue-500/10 group-hover:from-sky-500/20 group-hover:to-blue-500/20 transition-colors flex items-center justify-center overflow-hidden">
